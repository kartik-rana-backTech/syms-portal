-- Sudarshan Yuvak Mandal - Enterprise Production Master Schema v5.0 (Clean Reset)
-- Fully consolidated: base schema + all migrations in one file.
-- Run this for a COMPLETE CLEAN RESET with zero sample/test data.

SET NAMES utf8mb4 COLLATE utf8mb4_unicode_ci;
SET FOREIGN_KEY_CHECKS = 0;

CREATE DATABASE IF NOT EXISTS `sudarshan_yuvak_mandal` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `sudarshan_yuvak_mandal`;

-- DROP EXISTING TABLES (order respects foreign keys)
...
-- 1. USERS TABLE (OAuth columns native, phone and password_hash nullable)
CREATE TABLE `users` (
...
-- 5. REMEMBER TOKENS TABLE (Persistent Cookie Auth)
...
-- 9. SYSTEM ERROR LOGS TABLE (Auto-Purged Log Storage)
...
-- 10. MANDAL SETTINGS (Global Configuration & Branding)
...
-- 11. UTSAV EVENTS (Yearly Celebrations & Murtikar Details)
...
-- 13. EVENT MEMORIES (Photo & Video Gallery per Year)
...
-- 14. EVENT ROUTES (Aagman & Visarjan Procession Routes)
